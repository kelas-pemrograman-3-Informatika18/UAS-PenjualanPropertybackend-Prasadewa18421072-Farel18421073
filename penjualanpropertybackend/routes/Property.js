...
router.post('/insert', fields, (req, res) => {
    ...
    propertyController.insertProperty(data)
...
router.get('/getall', (req, res) => {
  ...
  router.get('/getbyid/:id', (req, res) => {
    propertyController.getbyId(req.params.id)
      .then(result => res.json(result))
      .catch((err) => res.json(err))
  })
...
router.put('/edit/:id', fields,(req, res) => {
    ...
    propertyController.edit(data, req.params.id, changeImage)
        .then(result => res.json(result))
        .catch(err => res.json(err))
  })
  ...
  router.delete('/delete/:id', (req, res) => {
    propertyController.delete(req.params.id)
      .then(result => res.json(result))
      .catch(err => res.json(err))
  })
